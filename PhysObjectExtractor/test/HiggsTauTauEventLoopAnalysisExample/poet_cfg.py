...
process.mytriggers = cms.EDAnalyzer('TriggerAnalyzer',
                              ...
                              triggerPatterns = cms.vstring("HLT_IsoMu24_eta2p1_v*","HLT_IsoMu24_v*","HLT_IsoMu17_eta2p1_LooseIsoPFTau20_v*"), 
...
process.p = cms.Path(process.mutaufilter+process.myevents+process.myelectrons+process.mymuons+process.mymets+process.mytaus+process.mypvertex+process.mygenparticle+process.mytriggers)
